...
- (void)configDefaultImageName {
    ...
    self.photoNumberIconImage = [self createImageWithColor:[UIColor colorWithRed:98/255.f green:166/255.f blue:255/255.f alpha:1] size:CGSizeMake(24, 24) radius:12]; // @"photo_number_icon";
